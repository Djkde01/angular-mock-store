  ...
  template: `
    ...
    >
      ...
      <span *ngIf="loading" class="flex items-center justify-center mr-2">
        <svg class="animate-spin h-4 w-4 border-2 border-white border-t-transparent rounded-full"></svg>
      </span>
...
export class ButtonComponent {
  ...
  getButtonClasses(): string {
    const baseClasses = 'relative inline-flex items-center justify-center font-medium rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 transform hover:scale-105';
