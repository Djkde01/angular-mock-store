...
import { CheckboxGroupComponent, CheckboxOption } from '../checkbox-group.component';
...
describe('CheckboxGroupComponent', () => {
  ...
  it('should display label when provided', () => {
    ...
    expect(labelElement.nativeElement.textContent.trim()).toBe('Test Checkbox Group');
  });
  ...
  it('should disable individual option when option.disabled is true', () => {
    const disabledCheckbox = fixture.debugElement.queryAll(By.css('input[type="checkbox"]'))[2];
  ...
  it('should display error message when showError is true', () => {
    ...
    expect(errorElement.nativeElement.textContent.trim()).toBe('Please select at least one option');
  });
  ...
  it('should display helper text when provided', () => {
    ...
    expect(helperElement.nativeElement.textContent.trim()).toBe('Select your preferences');
  });

  it('should update form control when checkbox is clicked', () => {
    const firstCheckbox = fixture.debugElement.queryAll(By.css('input[type="checkbox"]'))[0];
