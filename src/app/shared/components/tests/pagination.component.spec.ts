...
describe('PaginationComponent', () => {
  ...
  it('should display pagination info', () => {
    const infoElement = fixture.debugElement.query(By.css('.text-sm.text-gray-700'));
  ...
  it('should have Previous button disabled on first page', () => {
    ...
    const prevButton = fixture.debugElement.query(By.css('button[aria-label="Página anterior"]'));
  ...
  it('should have Next button disabled on last page', () => {
    ...
    const nextButton = fixture.debugElement.query(By.css('button[aria-label="Página siguiente"]'));
  ...
  it('should emit pageChange when page button is clicked', () => {
    ...
    const pageButton = pageButtons.find(btn => btn.nativeElement.textContent.trim() === '2');
    if (pageButton) {
