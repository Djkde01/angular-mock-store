    ...
    <div [class]="getAlertClasses()" role="alert">
      <div class="flex items-start">
        ...
        <div class="ml-3 flex-1">
          <h4 *ngIf="title" [class]="getTitleClasses()">{{ title }}</h4>
...
export class AlertComponent {
  ...
  getAlertClasses(): string {
    ...
    return `${baseClasses} ${typeClasses[this.type]} ${sizeClasses[this.size]} ${this.customClasses}`.trim();
  }
  ...
  getCloseButtonClasses(): string {
    const baseClasses = 'inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200';
