...
@Component({
  ...
  template: `
    <nav
      class="bg-white/80 backdrop-blur-sm shadow-lg border-b border-gray-200"
      role="navigation"
    >
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
          ...
          <div class="flex items-center">
            ...
            <div
              class="hidden md:flex items-center space-x-8 ml-8"
        ...
        <!-- Mobile menu -->
        <div
          *ngIf="mobileMenuOpen && navItems.length > 0"
